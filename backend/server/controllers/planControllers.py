...
def econ_context():
    ...
    #     "signals": insights,
    # }
# def submit_plan_snapshot(input: PlanningInput):
#     LOW_SAVINGS_RATE = 0.10
#     LOW_RUNWAY_MONTHS = 3
#     TIGHT_BUFFER = 0
#     snapshot = {
#         "savings_rate": ((input.income - input.expenses) / input.income) if input.income else None,
#         "monthly_buffer": input.income - input.expenses,
#         "runway_months": (input.liquid_savings / input.expenses) if input.expenses else None,
#         "pressure_level": "high"
#     }
#     plan_sql_query = """
#          SELECT 
...
#                          yoy_pct_change = row[4]
#                          as_of_date = row[5]
#                          #WWhy does this need to be in the for loop
#                          signals[metric_name] = {
#                               "trend_direction": trend_direction,
#                               "latest_value": latest_value,
#                               "mom_pct_change": mom_pct_change,
...
#                     inflation = signals["Inflation(cpi)"]
#                     rates = signals["Interest_Rates"]
#                     unemployment = signals["Unemployment_Rate"]
#     finally:
#         conn.close()
...
#     if (
#         inflation["trend_direction"] == "rising"
#     or (
#         inflation["mom_pct_change"] is not None
#         and inflation["mom_pct_change"] > 0
#     )
# ) and (
#         snapshot["savings_rate"] < LOW_SAVINGS_RATE
#         or snapshot["monthly_buffer"] <= TIGHT_BUFFER
# ):
#         insights.append({
#             "headline": "Inflation pressure on your budget",
#             "explanation": "Rising inflation combined with a low savings rate increases pressure on your purchasing power.",
#             "severity": "high",
#             "as_of_date": inflation["as_of_date"]
#         })  

#     if unemployment["trend_direction"] == "rising" and snapshot["runway_months"] < LOW_RUNWAY_MONTHS:
#          insights.append({
#             "headline": "Build Energency runway",
#             "explanation": "Build emergency runway; reduce discretionary spending until trend stabilizes",
#             "severity": "medium",
#             "as_of_date": unemployment["as_of_date"]
#          })
#     if (
#          inflation["trend_direction"] in ("stable", "falling")
#          and unemployment["trend_direction"] in ("stable", "falling")
#          and snapshot["savings_rate"] > LOW_SAVINGS_RATE
#     ):
#          insights.append({
#               "headline": "Favourable Conditions for saving",
#               "explanation": "Inflation and unemployment are stable/falling, so this is a good window to accelerate savings toward your goal.",
#               "severity": "low",
#               "as_of_date": as_of_date
#          })
